...
// Optimized soak test stages
export let options = {
    stages: [
        { duration: '15m', target: 50 },    // Ramp-up to 50 users over 15 minutes
        { duration: '6h', target: 50 },     // Maintain 50 users for 6 hours (soaking phase)
        { duration: '15m', target: 0 },     // Ramp-down to 0 users over 15 minutes
    ],
    thresholds: {
        http_req_duration: ['p(95)<800'],  // 95% of requests should finish within 800ms
    },
};

// Main function for the soak test
